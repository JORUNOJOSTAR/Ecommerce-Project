        ...
        <ul>
            <li class="relative">
                <a href="/src/cart.html"
                    ...
                    <!-- Cart Items Counter -->
                    <small x-text="$store.header.cartItems" x-show="$store.header.cartItems" x-transition
            ...
            @if(!Auth::guest())
                <li class="relative" x-data="{ open: false }">
                    ...
                    <ul x-show="open" x-transition class="w-full bg-slate-800">
                        <li>
                        ...
                        <li>
                            <a href="/src/watchlist.html"
                                ...
                                Watchlist
                                <!-- <small x-text="cartItems" x-show="cartItems" x-transition
                    class="py-[2px] px-[8px] rounded-full bg-red-500"></small> -->
                            </a>
                        </li>
                        <li>
                        ...
                        <li>
                            <form action="{{ route('logout') }}" method="POST">
                                @csrf
                                <button
                                    class="flex items-center py-2 px-4 transition-all hover:bg-slate-700 w-full">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mr-3">
                                        <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <ul class="grid grid-flow-col items-center">
            <li class="relative">
                <a href="/src/cart.html"
                    ...
                    Cart
                    <small x-text="$store.header.cartItems" x-show="$store.header.cartItems" x-transition x-cloak
                        class="z-20 absolute top-2 -right-1 py-[2px] px-[8px] rounded-full bg-red-500"></small>
                </a>
            </li>
            @if (!Auth::guest())
                <li x-data="{ open: false }" class="relative">
                    <a @click="open=!open"
                        class="cursor-pointer flex items-center py-navbar-item px-navbar-item transition-all hover:bg-slate-700">
                        My Account
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="w-5 h-5 ml-3">
                            <path stroke-linecap="round" stroke-linejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
                    ...
                    <ul x-cloak @click.outside="open=false" x-show="open" x-transition
                        class="absolute z-10 w-40 right-0 bg-slate-800">
                        <li>
                            <a href="/src/profile.html"
                                class="flex items-center py-2 px-4 transition-all hover:bg-slate-700">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                        ...
                        <li>
                            <a href="/src/watchlist.html"
                                class="flex items-center py-2 px-4 transition-all hover:bg-slate-700 justify-between">
                                <div class="flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mr-3">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                                ...
                                <small x-text="$store.header.watchListItems" x-show="$store.header.watchListItems"
                        ...
                        <li>
                            <form action="{{ route('logout') }}" method="POST">
                                @csrf
                                <button class="flex items-center py-2 px-4 transition-all hover:bg-slate-700 w-full">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mr-3">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                                            d="M15.75 9V5.25A2.25 2.25 0 0 0 13.5 3h-6a2.25 2.25 0 0 0-2.25 2.25v13.5A2.25 2.25 0 0 0 7.5 21h6a2.25 2.25 0 0 0 2.25-2.25V15m3 0 3-3m0 0-3-3m3 3H9" />
