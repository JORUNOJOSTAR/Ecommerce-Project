<x-app-layout>
    <div class="grid grid-cols-1 lg:grid-cols-5 gap-6 p-5">
                ...
                <div class="relative ">
                    <template x-for="image in images">
                        <div x-show="activeImage === image"
                            class="aspect-3/2 flex items-center justify-center bg-white">
                            <img :src="image" alt="" class="max-w-full max-h-full object-contain" />
                        </div>
                    </template>
        ...
        <div class="lg:col-span-2">
            ...
            <div class="flex items-center justify-between mb-3">
                ...
                <input type="number" value="1" x-ref="quantityEl"
