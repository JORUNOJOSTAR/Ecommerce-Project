    ...
    <Dialog as="div" @close="closeModal" class="relative z-10">
      ...
      <div class="fixed inset-0 overflow-y-auto">
        ...
        >
          ...
          >
            <DialogPanel 
              class="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p- text-left align-middle shadow-xl transition-all"
            >
              <Spinner v-if="loading"
                class="absolute left-0 top-0 bg-white right-0 bottom-0 flex items-center justify-center"/>
              <header class="py-3 px-4 flex justify-between items-center">
                <DialogTitle as="h3" class="text-lg leading-6 font-medium text-gray-950">
              ...
              <form @submit.prevent="onSubmit">
                <div class="bg-white px-4 pt-5 pb-4">
                  ...
                  <CustomInput type="number" class="mb-2" label="Price" v-model="product.price" prepend="$"/>
                </div>
